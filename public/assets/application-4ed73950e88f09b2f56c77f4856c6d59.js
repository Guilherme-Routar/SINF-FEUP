...
this.getProductContainer = function(product, img_path) {
  if (img_path === null) {
...
this.getProductContainer2 = function(product, img_path) {
  ...
  return '<div class="item  col-xs-12 col-sm-4 col-lg-4"> <div class="thumbnail"> <img id="img-artigo-' + product.CodArtigo + '" class="group list-group-image" src="' + img_path + '" alt="" /> <div class="caption"> <a href="/product/' + product.CodArtigo + '"><h4 class="group inner list-group-item-heading one-line-elipsis">' + product.DescArtigo + '</h4></a> <div class="container-fluid"> <div class="row"> <div class="col-xs-12 col-md-6"> <p class="lead">' + (product.PVP * (product.IVA / 100.0 + 1)).toFixed(2) + '€</p> </div> <div class="col-xs-12 col-md-6"> <a class="add-to-cart-btn btn btn-success" data-id-artigo="' + product.CodArtigo + '"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Adicionar</a> </div> </div> </div> </div> </div> </div>';
};

this.getImageFromProduct = function(idProduct) {
  var url_img;
  ...
  return $.ajax(url_img, {
    ...
    success: function(data) {
      ...
      try {
        if (data !== null) {
          return $('#img-artigo-' + idProduct).attr('src', data.image.url);
        }
      } catch (_error) {
        e = _error;
...
categorias_ignore = ['F01', 'M03', 'MP', 'PI', 'S01', 'BEBIDAS'];
$(document).ready(function () {
	...
	$.ajax({
        ...
        success: function(data) {
            ...
            for(var  i in categorias){
                if(categorias_ignore.indexOf(categorias[i].CodCategoria) < 0){
